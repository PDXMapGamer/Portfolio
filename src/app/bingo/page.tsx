  ...
  return (
    <>
      ...
      <div id="normal-bingo" className="grid grid-cols-5 grid-rows-5 w-[750px] [h-750px] mt-4">
        ...
        <BingoItem content="28 day reading streak" isFulfilled={false} notes="1/28 (peak: 6/28)" />
        ...
        <BingoItem content="28 day Github push streak*" isFulfilled={false} notes="0/28 (peak: 4/28)" />
        <BingoItem content="28 day anki streak" isFulfilled={false} notes="1/28 (peak: 5/28)" />
