  ...
  return (
    <>
      ...
      <div id="normal-bingo" className="grid grid-cols-5 grid-rows-5 w-[750px] [h-750px] mt-4">
        ...
        <BingoItem content="28 day reading streak" isFulfilled={false} notes="3/28 (peak: 3/28)" />
        ...
        <BingoItem content="28 day Github push streak*" isFulfilled={false} notes="2/28" />
