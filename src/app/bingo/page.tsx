  ...
  return (
    <>
      ...
      <div id="normal-bingo" className="grid grid-cols-5 grid-rows-5 w-[750px] [h-750px] mt-4">
        <BingoItem content="Finish kanji (N5-N3) workbook" isFulfilled={false} notes="451/617" />
        <BingoItem content="Complete 5 PHP Projects" isFulfilled={false} notes="0/5" />
        <BingoItem content="Clear my anki backlog" isFulfilled={true} notes="" />
        <BingoItem content="Fully incorporate ARIA to a website" isFulfilled={false} notes="" />
        <BingoItem content="Try learning 5 new programming languages" isFulfilled={false} notes="1/5" />
        ...
        <BingoItem content="28 day reading streak" isFulfilled={false} notes="5/28 (peak: 6/28)" />
        ...
        <BingoItem content="Read 10 books (any language)" isFulfilled={false} notes="1/10" />
        ...
        <BingoItem content="Reach Plat V in Yu-Gi-Oh Master Duel" isFulfilled={false} notes="Peak Gold III" />
        <BingoItem content="Learn 5 new things about SQL" isFulfilled={false} notes="0/5" />
        <BingoItem content="Read 5 Japanese books" isFulfilled={false} notes="1/5" />
        ...
        <BingoItem content="28 day Github push streak*" isFulfilled={false} notes="0/28" />
        <BingoItem content="28 day anki streak" isFulfilled={false} notes="1/28 (peak: 7/28)" />
        <BingoItem content="Find a language exchange pen pal" isFulfilled={false} notes="" />
